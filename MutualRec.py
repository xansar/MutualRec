...
class SpatialAttentionLayer_GAT(nn.Module):
    def __init__(self, embedding_size=1, num_heads=1):
        ...
        self.gat_layer_1 = dglnn.HeteroGraphConv(
            {
                'rate': dglnn.GATv2Conv(embedding_size, embedding_size, num_heads=num_heads),
                'rated': dglnn.GATv2Conv(embedding_size, embedding_size, num_heads=num_heads),
                'friend': dglnn.GATv2Conv(embedding_size, embedding_size, num_heads=num_heads),
            },
            aggregate='sum'
        )
